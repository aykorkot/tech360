...
$(document).ready(function(){
            ...
            $.ajax({
                ...
                success: function(json){
                    ...
                    {                        
                        ...
                        {
                            $('.mm_menus_li').removeClass('open');
                            $('.mm_menus > ul.mm_menus_ul .btn-new').before('<li class="mm_menus_li '+(!json.vals.enabled ? ' mm_disabled ' : '')+' item'+json.itemId+' open" data-id-menu="'+json.itemId+'" data-obj="menu">'+json.vals.html_content+'</li>');
   ...
   $(document).on('submit','.mm_form form',function(){
      return false;
   });
