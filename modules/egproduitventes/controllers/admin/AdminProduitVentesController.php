...
class AdminProduitVentesController extends ModuleAdminController
{
    protected $position_identifier = 'id_egproduitventes';
    
    public function __construct()
    {
        $this->table = 'egproduitventes';
        $this->className = 'EgProduitVentesClass';
        $this->identifier = 'id_egproduitventes';
    ...
    public function renderForm()
    {
        ...
        $selectedCategory = EgProduitVentesClass::getCategorySelectedById((int)Tools::getValue('id_egproduitventes'));
    ...
    public function ajaxProcessUpdatePositions()
    {
        ...
        foreach ($positions as $position => $value) {
            ...
            if (isset($pos[2]) && (int)$pos[2] === $id) {
                if ($item = new EgProduitVentesClass((int)$pos[2])) {
