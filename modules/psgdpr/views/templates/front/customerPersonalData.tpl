...
<section class="page_content">
    <div class="psgdpr-row">
        <div class="psgdprinfo17">
            ...
            <div class="psgdpr-btn">
                <a id="exportDataToCsv" class="btn btn-white psgdprgetdatabtn17" target="_blank" href="{$psgdpr_csv_controller|escape:'htmlall':'UTF-8'}">{l s='Exporter en CSV' mod='psgdpr'}</a>
                <a id="exportDataToPdf" class="btn btn-white psgdprgetdatabtn17" target="_blank" href="{$psgdpr_pdf_controller|escape:'htmlall':'UTF-8'}">{l s='Exporter en PDF' mod='psgdpr'}</a>
            </div>
        </div>
        <div class="psgdprinfo17">
