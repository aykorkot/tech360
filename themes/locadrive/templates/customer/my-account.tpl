    ...
    <div class="links">
      ...
      <a class="col-lg-4 col-md-6 col-sm-6 col-xs-12" id="identity-link" href="{$urls.pages.identity}">
        <span class="link-item">
          ...
          {l s='Informations' d='Shop.Theme.Customeraccount'}
        </span>
      </a>
      ...
      {if !$configuration.is_catalog}
        <a class="col-lg-4 col-md-6 col-sm-6 col-xs-12" id="history-link" href="{$urls.pages.history}">
          <span class="link-item">
            <i class="material-icons">&#xE916;</i>
            {l s='Historique des commandes' d='Shop.Theme.Customeraccount'}
          </span>
        </a>
      {/if}
...
{block name='page_footer'}
  {block name='my_account_links'}
    <div class="text-sm-center">
      <a href="{$urls.actions.logout}" class="btn btn-white">
        {l s='Se déconnecter' d='Shop.Theme.Actions'}
      </a>
    </div>
  {/block}
{/block}
