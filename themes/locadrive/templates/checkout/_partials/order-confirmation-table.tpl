...
<div id="order-items" class="col-md-12">
  {* <div class="row row-header">
    {block name='order_items_table_head'}
      <div class="card-title h3 col-md-6 col-12">{l s='Order items' d='Shop.Theme.Checkout'}</div>
      <div class="card-title h3 col-md-2 text-md-center _desktop-title">{l s='Unit price' d='Shop.Theme.Checkout'}</div>
      <div class="card-title h3 col-md-2 text-md-center _desktop-title">{l s='Quantity' d='Shop.Theme.Checkout'}</div>
      <div class="card-title h3 col-md-2 text-md-center _desktop-title">{l s='Total products' d='Shop.Theme.Checkout'}</div>
    {/block}
  </div> *}
      ...
      {foreach from=$products item=product}
        <div class="order-line">
          ...
          <div class="order-line-content">
            {if $add_product_link}<a href="{$product.url}" target="_blank" class="product-name">{/if}
            ...
            <div class="price">{l s='Prix unitaire'} : <span class="value">{$product.price}</span></div>
            <div class="quantity">{l s='Quantité'} : <span class="value">{$product.quantity}</span></div>
            <div class="price-total">{l s='Total'} : <span class="value">{$product.total}</span></div>
          </div>
        </div>
      {/foreach}
