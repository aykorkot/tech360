  ...
  <div class="delivery-options-list">
    {if $delivery_options|count}
      ...
      >
            ...
            <div class="delivery-options">
              {foreach from=$delivery_options item=carrier key=carrier_id}
                  <div class="row delivery-option js-delivery-option">
                    <div class="col-sm-1 col-checkbox">
                    ...
                    <label for="delivery_option_{$carrier.id}" class="col-xs-9 col-sm-11 delivery-option-2">
                      <div class="row">
                        ...
                        <div class="col-sm-3 col-xs-12 col-price">
        ...
        <button type="submit" class="continue btn btn-white" name="confirmDeliveryOption" value="1">
