  ...
  <div class="js-address-form">
    ...
    >
      ...
      {elseif $customer.addresses|count > 0}
        ...
        <p class="add-address">
          <a href="{$new_address_delivery_url}"><i class="material-icons">&#xE145;</i>{l s='Nouvelle adresse' d='Shop.Theme.Actions'}</a>
        </p>

        {if $use_same_address && !$cart.is_virtual}
          <p>
            <a data-link-action="different-invoice-address" href="{$use_different_address_url}">
              {l s='Adresse de facturation différente ?' d='Shop.Theme.Checkout'}
            </a>
          </p>
        {/if}
      ...
      {if !$use_same_address}
        ...
        {else}
          ...
          <p class="add-address">
            <a href="{$new_address_invoice_url}"><i class="material-icons">&#xE145;</i>{l s='Nouvelle adresse' d='Shop.Theme.Actions'}</a>
          </p>
        {/if}
      ...
      {if !$form_has_continue_button}
        <div class="btn-address clearfix">
          <button type="submit" class="btn btn-white continue" name="confirm-addresses" value="1">
