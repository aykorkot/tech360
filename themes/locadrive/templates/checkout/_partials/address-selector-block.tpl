    ...
    >
      ...
      <footer class="address-footer">
        {if $interactive}
          ...
          >
          <img width="22" height="22" src="{$urls.img_url}edit.svg" alt="Modifier" loading="lazy">
          </a>
          <a
          ...
          >
          <img width="22" height="22" src="{$urls.img_url}trash.svg" alt="Supprimer" loading="lazy">
          </a>
        {/if}
      </footer>
    </article>
