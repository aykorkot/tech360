...
<div class="cart-summary-products js-cart-summary-products">
    <div class="cart-summary-products-top">
        <h2>{l s='Résumé de la commande' d='Shop.Theme.Global'}</h2>
        {* <a href="{$urls.pages.cart}" class="back__button back__button--right">
            <span>{l s='Modifier le panier' d='Shop.Theme.Actions'}</span>
            <div>
            <span>
    ...
    {* {block name='cart_summary_product_list'}
        <div class="cart-summary-product-list" id="cart-summary-product-list">
            <ul class="media-list">
